...
export function HelpPage() {
  ...
  return (
    <>
      ...
      <MyModal display={display} setDisplay={setDisplay}>
      ...
      <MyModal display={display2} setDisplay={setDisplay2}>
        <div className="relative h-full w-full max-w-2xl p-4 md:h-auto">
          <div className="relative rounded-lg bg-white shadow dark:bg-gray-700">
            <div className="flex items-start justify-between rounded-t border-b p-5 dark:border-gray-600">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white lg:text-2xl">
            ...
            <div className="space-y-6 p-6">
              <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">modal2</p>
              <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">modal2</p>
            </div>
            <div className="flex items-center space-x-2 rounded-b border-t border-gray-200 p-6 dark:border-gray-600">
              <button
